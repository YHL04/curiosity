...
class PPO:
    ...
    def __init__(self, state_size, action_size):
        ...
        self.actor = FeedForward(state_size, action_size)
        self.critic = FeedForward(state_size, action_size)
    ...
    def get_action(self, state):
        ...
        # Create a distribution with mean action and std for covariance matrix
